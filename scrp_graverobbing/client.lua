...
RegisterNetEvent('scrp_graverobbing:TriggerRobbery')
AddEventHandler('scrp_graverobbing:TriggerRobbery', function()
	...
	for key, value in pairs(gravestones) do
		...
		if gravestone then
			...
			TriggerServerEvent("scrp_graverobbing:Complete")
		end
	end
end)
